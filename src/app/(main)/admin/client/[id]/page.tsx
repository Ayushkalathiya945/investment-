...
import { ArrowUp, ArrowUpRight, ChevronLeft, Circle, CreditCard, IndianRupee, Locate, Mail, MapPin, Phone, TrendingDown, TrendingUp, Users } from 'lucide-react'
        ...
        <div className="flex flex-col w-full min-h-[94vh] gap-5">
            <div className="flex justify-between w-full">
                ...
                <div className="flex gap-2">
                    <Button className="ml-auto bg-transparent shadow-none text-red-400 border border-red-300 hover:bg-red-50 px-10 rounded-xl">Delete</Button>
                    <AddClient name="Edit"/>
                </div>
            </div>
